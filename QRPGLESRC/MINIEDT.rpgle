     ...
     C                   MOVEL     *BLANKS       ASSTVAL
     C                   MOVEL     OANAME        ASSTNAME
     C                   MOVEL     *BLANKS       ASSTDESC
     C                   MOVEL     OATYPE        ASSTTYP
     C                   MOVEL     *BLANKS       ASSTSTS
     C                   MOVEL     *BLANKS       ASSTFUNC
     C                   MOVEL     OAATYPE       ASSTACQT
     C                   MOVEL     OAQTY         ASSTQTY
     C                   MOVEL     *BLANKS       ASSTDONOR
     C                   MOVEL     OADATEACQ     ASSTACQ
     C                   MOVEL     DUMMYDATE     ASSTDISP
     C                   MOVEL     OAREIMB       ASSTREMB
     C                   MOVEL     *BLANKS       ASSTTAX
     C                   MOVEL     *BLANKS       ASSTMT
     C                   MOVEL     *BLANKS       ASSTM
     C                   MOVEL     OASN          ASSTSN
